...
import org.d3if3086.mobpro1.util.SettingsDataStore
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.tambah_review),
                    tint = colorResource(R.color.brick)
                )
            }
        }
                ...
                onClick = {
                    shareData(
                        ...
                        message = context.getString(
                            ...
                            bakso.nama, bakso.deskripsi, bakso.review, bakso.rating
                        )
                    )
                }
            ) {
